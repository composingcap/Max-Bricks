...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 575.0, 130.0, 103.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "multichannelsignal", "", "" ],
					"patching_rect" : [ 401.0, 130.0, 103.0, 23.0 ],
					"text" : "_mb.inputHandler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "multichannelsignal", "", "" ],
					"patching_rect" : [ 227.0, 130.0, 103.0, 23.0 ],
					"text" : "_mb.inputHandler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "multichannelsignal", "", "" ],
					"patching_rect" : [ 45.0, 130.0, 103.0, 23.0 ],
					"text" : "_mb.inputHandler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 624.0, 219.0, 86.0, 23.0 ],
					"restore" : [ 						{
							"data" : 							{
								"numins" : 4,
								"numouts" : 4
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 538.0, 219.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 538.0, 329.0, 186.0, 79.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 48.0, 160.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.0, 383.0, 157.0, 23.0 ],
					"text" : "mc.matrix~ 4 4 0. @ramp 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 447.0, 473.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.0, 470.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 798.0, 213.0, 53.0, 23.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 20.0, 129.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 538.0, 244.0, 39.0, 23.0 ],
					"text" : "dump"
				}
