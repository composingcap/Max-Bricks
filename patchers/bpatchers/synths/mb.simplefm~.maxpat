...
,
		"classnamespace" : "box",
		"rect" : [ 1246.0, 414.0, 1191.0, 930.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 994.25, 156.0, 72.0, 23.0 ],
					"text" : "r #0_adsr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.25, 654.5, 71.0, 23.0 ],
					"text" : "r #0_gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.25, 469.0, 102.0, 23.0 ],
					"text" : "r #0_modIndex"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 382.5, 103.5, 23.0 ],
					"text" : "r #0_freqRatio"
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 1983.0, 538.0, 1082.0, 597.0 ],
						"bglocked" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 169.25, 242.0, 72.0, 23.0 ],
									"text" : "s #0_adsr"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 123.25, 209.0, 72.0, 23.0 ],
									"text" : "s #0_gain"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 92.25, 165.0, 103.0, 23.0 ],
									"text" : "s #0_modIndex"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 134.0, 99.0, 23.0 ],
									"text" : "s #0_freqRatio"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "route freqRatio modInex gain adsr"
								}
...
,
					"patching_rect" : [ 178.5, 238.0, 37.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 438.5, 685.0, 59.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 329.0, 685.0, 91.0, 23.0 ],
					"text" : "_mb.param gain"
				}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 2 ],
							"parameter_initial_enable" : 1,
							"parameter_longname" : "freqRatio[3]",
							"parameter_mmax" : 5.0,
							"parameter_mmin" : 1.0,
							"parameter_shortname" : "freq ratio",
							"parameter_type" : 0,
							"parameter_unitstyle" : 1
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 228.0, 101.5, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 170.0, 685.0, 136.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 82.33333146572113, 101.5, 73.0, 18.0 ],
					"text" : "Envelope Time",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 162.0, 101.5, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 722.0, 30.0, 30.0 ]
				}
