...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 439.0, 475.0, 59.0, 23.0 ],
					"restore" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 331.0, 475.0, 91.0, 23.0 ],
					"text" : "_mb.param gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 603.0, 204.0, 91.0, 23.0 ],
					"restore" : [ 0.5 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 468.0, 204.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 387.0, 198.0, 68.0, 36.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"restore" : [ 245.355856456977705, 2000.0, 0.316470588235294, 2000.0, 0.0, 1.0, 0.0, 0.029411764705882, 0.46815834767642, -0.831313994443703 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 181.0, 322.0, 53.0, 23.0 ],
					"text" : "zl.slice 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 177.0, 401.0, 299.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 78.0, 41.5, 73.0, 18.0 ],
					"text" : "Envelope Time",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"attack_time" : 245.355856456977705,
