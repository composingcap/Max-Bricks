...
,
					"patching_rect" : [ 193.0, 580.5, 113.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 181.5, 11.5, 108.0, 30.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 393.5, 663.0, 57.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 287.0, 663.0, 89.0, 23.0 ],
					"text" : "_mb.param pan"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 346.5, 627.0, 62.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "int" ],
					"patching_rect" : [ 240.0, 627.0, 91.0, 23.0 ],
					"text" : "_mb.param gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "int" ],
					"patching_rect" : [ 205.5, 113.0, 127.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1221.0, 116.5, 79.0, 23.0 ],
					"text" : "_mb.adsrtime"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "int" ],
					"patching_rect" : [ 1221.0, 78.0, 102.0, 23.0 ],
...
,
						"classnamespace" : "box",
						"rect" : [ 2210.0, 556.0, 1082.0, 597.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 268.0, 285.0, 77.0, 23.0 ],
									"text" : "routepass int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.75, 265.0, 29.5, 23.0 ],
									"text" : "2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 150.75, 270.0, 29.5, 23.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 94.75, 270.0, 29.5, 23.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 94.0, 232.0, 169.0, 23.0 ],
									"text" : "sel lowpass bandpass highpass"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 182.0, 147.0, 72.0, 23.0 ],
									"text" : "s #0_gain"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 138.0, 125.0, 72.0, 23.0 ],
									"text" : "s #0_adsr"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 94.75, 336.0, 98.0, 23.0 ],
									"text" : "s #0_response"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 143.0, 104.0, 23.0 ],
									"text" : "s #0_resonance"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 50.0, 100.0, 195.0, 23.0 ],
									"text" : "route resonance response adsr gain"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 226.0, 183.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 184.0, 329.0, 195.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Lato",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1371.5, 104.0, 86.0, 23.0 ],
					"restore" : [ 6000.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 618.0, 204.0, 91.0, 23.0 ],
					"restore" : [ 0.5 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "int" ],
					"patching_rect" : [ 483.0, 204.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 402.0, 198.0, 68.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 206.0, 72.5, 54.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 227.0, 184.0, 85.0, 23.0 ],
					"restore" : [ 1.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.0, 264.0, 80.0, 23.0 ],
					"text" : "resonance $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 260.0, 226.0, 49.0, 20.0 ],
					"pictures" : [ "highcut.svg", "bandpass.svg", "lowcut.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 206.0, 49.0, 49.0, 20.0 ],
					"remapsvgcolors" : 1,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 191.0, 416.0, 53.0, 23.0 ],
					"text" : "zl.slice 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 191.0, 500.0, 299.0, 23.0 ],
					"text" : "poly~ _mb.poly.subtractivesynth 32 @target 0 @steal 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 117.0, 198.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 137.0, 18.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 42.5, 73.0, 18.0 ],
					"text" : "adsr",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 153.0, 42.5, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.0, 449.0, 102.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"attack_slope" : 0.029411764705882,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 580.5, 473.0, 87.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 84.0, 150.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 277.0, 2.5, 5.0, 5.0 ],
					"proportion" : 0.39,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 12.5, 138.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 727.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 272.5, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 248.0, 65.0, 23.0 ],
					"text" : "allnotesoff"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 934.0, 484.0, 35.0, 38.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 249.5, 717.0, 486.5, 717.0, 486.5, 562.5, 249.5, 562.5 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 900.0, 439.0, 1117.0, 439.0, 1117.0, 276.5, 900.0, 276.5 ],
					"order" : 0,
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 296.5, 704.0, 464.5, 704.0, 464.5, 569.5, 296.5, 569.5 ],
					"source" : [ "obj-76", 0 ]
				}
