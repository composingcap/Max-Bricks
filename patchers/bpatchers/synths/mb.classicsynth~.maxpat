...
,
		"classnamespace" : "box",
		"rect" : [ 1693.0, 222.0, 1140.0, 937.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.0, 549.0, 71.0, 23.0 ],
					"text" : "r #0_gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1003.5, 117.0, 72.0, 23.0 ],
					"text" : "r #0_adsr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 257.5, 102.0, 23.0 ],
					"text" : "r #0_filterRatio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.5, 176.0, 84.0, 23.0 ],
					"text" : "r #0_filterQ"
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 1507.0, 696.0, 1082.0, 597.0 ],
						"bglocked" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 163.0, 255.0, 72.0, 23.0 ],
									"text" : "s #0_gain"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 124.0, 205.0, 72.0, 23.0 ],
									"text" : "s #0_adsr"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 83.0, 169.0, 103.0, 23.0 ],
									"text" : "s #0_filterRatio"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 134.0, 85.0, 23.0 ],
									"text" : "s #0_filterQ"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "route filterQ filterRatio adsr gain"
								}
...
,
					"patching_rect" : [ 171.0, 170.0, 37.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 438.5, 556.0, 59.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 334.0, 556.0, 91.0, 23.0 ],
					"text" : "_mb.param gain"
				}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_mmax" : 8.0,
							"parameter_mmin" : 1.0,
							"parameter_shortname" : "filter ratio",
							"parameter_type" : 0,
							"parameter_unitstyle" : 1
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 154.0, 18.5, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 179.0, 556.0, 136.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 97.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
