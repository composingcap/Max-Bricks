...
,
					"patching_rect" : [ 176.5, 759.5, 113.0, 42.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 377.0, 842.0, 57.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 270.5, 842.0, 89.0, 23.0 ],
					"text" : "_mb.param pan"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 330.0, 806.0, 62.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "int" ],
					"patching_rect" : [ 223.5, 806.0, 91.0, 23.0 ],
					"text" : "_mb.param gain"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 118.5, 18.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 12.5, 96.0, 26.0 ],
					"text" : "Double FM",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 233.0, 896.0, 470.0, 896.0, 470.0, 741.5, 233.0, 741.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 280.0, 883.0, 448.0, 883.0, 448.0, 748.5, 280.0, 748.5 ],
					"source" : [ "obj-76", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-26" : [ "fold[1]", "freqRatio1", 0 ],
			"obj-36" : [ "fold[2]", "modIndex1", 0 ],
			"obj-37" : [ "fold[3]", "freqRatio2", 0 ],
			"obj-38" : [ "fold[4]", "modIndex2", 0 ],
