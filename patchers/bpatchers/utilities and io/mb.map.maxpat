...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1038.0, 636.0, 68.0, 23.0 ],
					"text" : "none::none"
				}
...
, 			{
				"box" : 				{
					"activebgcolor" : [ 0.72156862745098, 0.72156862745098, 0.72156862745098, 1.0 ],
					"activebgoncolor" : [ 1.0, 0.952941176470588, 0.298039215686275, 1.0 ],
					"id" : "obj-124",
					"maxclass" : "live.text",
					"mode" : 0,
					"numinlets" : 1,
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1038.0, 617.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 232.083333333333314, 70.0, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 290.0, 133.5, 33.0, 23.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 290.0, 168.0, 23.0, 23.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 290.0, 119.5, 60.0, 23.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 619.0, 68.0, 33.0, 23.0 ],
					"text" : "t 1 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 425.0, 39.5, 29.5, 23.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 625.0, 39.5, 43.0, 23.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 625.0, 8.0, 143.0, 23.0 ],
					"text" : "r _MB.MAPLEARNSTATE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1111.0, 840.0, 23.0, 23.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1119.0, 886.0, 144.0, 23.0 ],
					"text" : "s _MB.MAPLEARNSTATE"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 973.0, 943.0, 144.0, 23.0 ],
					"text" : "s _MB.MAPLEARNSTATE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1082.0, 797.0, 33.0, 23.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 414.5, 68.0, 29.5, 23.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 270.0, 952.0, 29.5, 23.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 983.5, 865.0, 56.0, 23.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 1105.5, 42.0, 23.0 ],
					"text" : "zlclear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 170.333333333333314, 1203.0, 57.0, 23.0 ],
					"text" : "zl.change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 897.583333333333258, 724.0, 23.0, 23.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 973.0, 811.0, 50.5, 23.0 ],
					"text" : "t 0 l 0 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 973.0, 780.0, 31.0, 23.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 985.0, 746.0, 144.0, 23.0 ],
					"text" : "r _MB.PARAMTOUCHED"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 897.583333333333258, 773.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 232.083333333333314, 41.5, 44.0, 25.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.583333333333258, 299.0, 129.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 228.0, 912.0, 78.0, 23.0 ],
					"text" : "route symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 846.0, 326.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 609.083333333333258, 1100.0, 23.0, 23.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 477.0, 1093.0, 23.0, 23.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 528.083333333333258, 1075.0, 79.0, 23.0 ],
					"text" : "sel _set _mod"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 699.0, 1244.0, 47.0, 23.0 ],
					"text" : "route 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 703.0, 1211.0, 70.0, 23.0 ],
					"text" : "route mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 703.0, 1175.5, 100.0, 23.0 ],
					"text" : "r #0_mapMess"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.083333333333258, 1203.0, 62.0, 23.0 ],
					"text" : "prepend 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 568.083333333333258, 1166.0, 37.0, 23.0 ],
					"text" : "_mod"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.0, 1237.0, 85.0, 23.0 ],
					"text" : "prepend mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 523.583333333333258, 1166.0, 30.0, 23.0 ],
					"text" : "_set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 528.0, 1262.0, 101.0, 23.0 ],
					"text" : "s #0_mapMess"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 523.583333333333258, 1137.0, 43.0, 23.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"activebgoncolor" : [ 0.870588235294118, 0.298039215686275, 1.0, 1.0 ],
					"id" : "obj-5",
					"maxclass" : "live.text",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 523.583333333333258, 1119.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.583333333333314, 70.0, 38.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 1128.0, 50.0, 23.0 ],
					"text" : "none"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1023.5, 243.0, 75.0, 23.0 ],
					"text" : "_mb.lfoInput"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 766.0, 1140.0, 93.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 819.0, 997.0, 55.0, 23.0 ],
					"text" : "route val"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 819.0, 943.0, 100.0, 23.0 ],
					"text" : "r #0_mapMess"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 103.0, 83.0, 23.0 ],
					"text" : "prepend mute"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.0, 138.5, 101.0, 23.0 ],
					"text" : "s #0_mapMess"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.583333333333258, 979.0, 83.0, 23.0 ],
					"text" : "prepend mute"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.583333333333258, 1024.5, 101.0, 23.0 ],
					"text" : "s #0_mapMess"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 558.083333333333258, 853.0, 46.5, 23.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.583333333333258, 925.0, 52.0, 23.0 ],
					"text" : "prepend"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 184.5, 70.0, 38.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgoncolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 481.583333333333258, 8.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"restore" : [ 						{
							...
							"6" : "mb.plate~::detune",
							"3" : "mb.plate~::detune",
							"4" : "mb.pluck~::pluckColor",
							"7" : "mb.plate~::brightness"
						}
 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.0, 299.0, 129.0, 23.0 ],
					"text" : "tosymbol @separator ::"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 546.583333333333258, 442.0, 101.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.583333333333258, 181.0, 92.0, 23.0 ],
					"text" : "r _MB.PARAMS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 416.583333333333258, 430.0, 109.0, 23.0 ],
					"text" : "s _MB.PARAMGET"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 752.0, 425.0, 62.0, 23.0 ],
					"text" : "t 1 b b 0 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 377.0, 997.0, 63.0, 23.0 ],
					"text" : "symbol $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 170.333333333333314, 1168.0, 142.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 179.75, 997.0, 147.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 1041.0, 95.0, 23.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.583333333333314, 965.0, 26.0, 23.0 ],
					"text" : "iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 228.0, 879.0, 101.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 228.0, 1097.0, 154.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.583333333333314, 44.0, 92.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.5,
					"id" : "obj-1",
					"items" : [ "none", ",", "mb.lfo~", ",", "mb.modalSynth~", ",", "mb.plate~", ",", "mb.pluck~" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"presentation" : 1,
					"presentation_rect" : [ 17.083333333333314, 44.0, 97.0, 20.0 ]
				}
