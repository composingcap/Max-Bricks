...
,
		"classnamespace" : "box",
		"rect" : [ 1200.0, 332.0, 1268.0, 915.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 586.0, 101.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.0, 390.0, 82.0, 23.0 ],
					"text" : "prepend store"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 534.0, 29.5, 23.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 339.0, 33.0, 41.0, 23.0 ],
					"text" : "unjoin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 232.5, 456.0, 29.5, 23.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.0, 344.0, 40.0, 23.0 ],
					"text" : "t b i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 348.0, 115.0, 29.5, 23.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 348.0, 87.0, 29.5, 23.0 ],
					"text" : "!= 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 348.0, 142.0, 41.0, 23.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.0, 361.0, 29.5, 23.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 243.0, 421.0, 50.5, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 25.5, 234.0, 40.0, 23.0 ],
					"text" : "t i i b"
				}
