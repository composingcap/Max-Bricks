...
,
		"classnamespace" : "box",
		"rect" : [ 1587.0, 400.0, 1268.0, 915.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 322.0, 230.0, 92.0, 23.0 ],
					"restore" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 485.0, 295.0, 102.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 621.0, 295.0, 70.0, 23.0 ],
					"restore" : [ 250.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 205.0, 213.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 473.5, 406.0, 37.0, 23.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 883.5, 437.0, 23.0, 23.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 862.5, 401.0, 46.0, 23.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 820.5, 330.0, 118.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 828.0, 365.0, 103.0, 23.0 ],
					"text" : "transport"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 473.5, 445.0, 133.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 366.0, 346.0, 71.5, 23.0 ],
					"text" : "typeroute~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 366.0, 264.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 113.0, 8.5, 38.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 366.0, 295.0, 57.5, 30.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 113.0, 22.5, 50.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 83.5, 169.0, 51.0, 23.0 ],
					"text" : "unjoin 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 83.5, 223.0, 56.0, 23.0 ],
					"text" : "stripnote"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.5, 285.5, 86.0, 23.0 ],
					"text" : "_mb.makenote"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.5, 375.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 10.5, 108.0, 26.0 ],
					"text" : "MIDI Length",
