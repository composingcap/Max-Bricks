...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 552.0, 455.0, 113.0, 23.0 ],
					"restore" : [ 127.0, 0.0, 127.0, 0.0, 0.0, 1, 0.0, 63.0, 63.0, 0, 0.0, 127.0, 127.0, 1, 0.0, "curve" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
,
					"text" : "pattr dynamicCurve",
					"varname" : "dynamicCurve"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 279.0, 556.0, 29.5, 23.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 598.0, 40.0, 23.0 ],
					"text" : "join 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 236.75, 399.0, 51.0, 23.0 ],
					"text" : "unjoin 3"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.0, 1, 0.0, 63.0, 63.0, 0, 0.0, 127.0, 127.0, 1, 0.0 ],
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 247.416666666666629, 430.0, 200.0, 100.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.416666666666629, 42.5, 173.583333333333371, 44.0 ],
					"range" : [ 0.0, 127.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 384.75, 628.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 236.75, 324.0, 29.5, 23.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 215.25, 215.0, 29.5, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 236.75, 356.0, 162.0, 23.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 236.75, 287.0, 32.0, 23.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 225.75, 255.5, 41.0, 23.0 ],
					"text" : "unjoin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 20.0, 137.0, 46.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 12.5, 128.0, 46.0 ],
					"text" : "Midi Dynamics\n",
