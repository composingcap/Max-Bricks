...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 62.0, 239.0, 21.0 ],
					"presentation_linecount" : 2,
					"text" : "Karplus Strong string physical model"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 93.0, 150.0, 35.0 ],
					"text" : "Teaching Text or HTML Document"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 10.0, 358.0, 35.0 ],
					"text" : "mb.pluck~"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 469.0, 27.0, 290.0, 120.0 ],
					"varname" : "mb.notein[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 469.0, 260.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 469.0, 332.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 469.0, 166.0, 190.0, 80.0 ],
					"varname" : "mb.pluck~[1]",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-5::obj-100" : [ "brightness[5]", "brightness", 0 ],
			"obj-5::obj-102" : [ "resonance[4]", "resonance", 0 ],
			"obj-5::obj-16" : [ "gain[1]", "gain", 0 ],
			"obj-5::obj-7" : [ "pluck color[1]", "pluck color", 0 ],
			"obj-5::obj-93" : [ "live.text[1]", "live.text", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
