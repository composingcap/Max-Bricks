...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 213.5, 250.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 136.5, 250.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 310.0, 153.0, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 262.0, 138.0, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 178.0, 150.0, 68.0 ],
					"presentation_linecount" : 4,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.0, 370.0, 150.0, 54.0 ],
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 125.0, 150.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 78.5, 250.0, 50.0 ],
...
,
					"patching_rect" : [ 427.0, 10.0, 290.0, 120.0 ],
					"varname" : "mb.notein",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 427.0, 144.0, 290.0, 220.0 ],
...
,
					"patching_rect" : [ 427.0, 466.0, 190.0, 90.0 ],
					"varname" : "mb.audioOut",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 427.0, 410.0, 190.0, 40.0 ],
					"varname" : "mb.pan~",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-14::obj-25" : [ "dspState[4]", "dspState", 0 ],
			"obj-14::obj-3" : [ "live.gain~[7]", "live.gain~", 0 ],
			"obj-14::obj-9" : [ "live.numbox[4]", "live.numbox", 0 ],
			"obj-17::obj-2" : [ "_pan[1]", "pan", 0 ],
			"obj-17::obj-27" : [ "_gain[1]", "gain", 0 ],
			"obj-3::obj-3" : [ "midiInputSelect[1]", "midiInputSelect", 0 ],
			"obj-9::obj-19" : [ "live.text[10]", "live.text[1]", 0 ],
			"obj-9::obj-26" : [ "fold[3]", "fold", 0 ],
			"obj-9::obj-44" : [ "envelopeTime[2]", "envelopeTime", 0 ],
			"obj-9::obj-45" : [ "nharmonics[2]", "nharmonics", 0 ],
			"obj-9::obj-76" : [ "gain[2]", "gain", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
