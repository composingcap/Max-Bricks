...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "mb.midiLength.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 198.0, 190.0, 40.0 ],
					"varname" : "mb.midiLength[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 62.0, 290.0, 120.0 ],
					"varname" : "mb.notein[1]",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-21::obj-19" : [ "live.text[15]", "live.text[1]", 0 ],
			"obj-21::obj-4" : [ "wavefold", "wavefold", 0 ],
			"obj-21::obj-44" : [ "live.numbox[5]", "live.numbox", 0 ],
			"obj-21::obj-76" : [ "live.gain~[5]", "live.gain~", 0 ],
			"obj-21::obj-93" : [ "live.text[17]", "live.text", 0 ],
			...
			"obj-9::obj-93" : [ "live.text[12]", "live.text", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
