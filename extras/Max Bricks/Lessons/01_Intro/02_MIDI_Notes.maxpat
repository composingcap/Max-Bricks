...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 841.0, 231.5, 18.0, 78.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 613.5, 296.0, 100.0, 20.0 ],
					"text" : "Note off",
					"texton" : "Note on"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 613.5, 268.0, 29.5, 23.0 ],
					"text" : "!= 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 228.0, 275.0, 78.0 ],
					"text" : "MIDI velocity represents how loud a sound will be, you can think of it as having 128 different loudness steps. A velocity over 0 indicates a \"note on\" message as where a velocity of 0 indicates a \"note off\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 139.5, 280.0, 64.0 ],
					"text" : "MIDI pitch and velocity are values from 0 to 127, 0 being the lowest value and 127 being the highest. MIDI pitches increase be semitones, so each integer number is a unique note on the keyboard. "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 841.0, 171.5, 189.0, 21.0 ],
					"text" : "Max Bricks note ID (not MIDI)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 721.0, 169.5, 118.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 669.5, 237.5, 150.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 637.0, 207.5, 150.0, 21.0 ],
					"text" : "Midi pitch (0-127)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 613.5, 237.5, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 585.0, 207.5, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 585.0, 169.5, 76.0, 23.0 ],
					"text" : "unpack 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 66.5, 277.0, 35.0 ],
					"text" : "MIDI notes are made up of two components: pitch and velocity."
				}
...
,
					"patching_rect" : [ 482.0, 324.0, 290.0, 120.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-93", 0 ],
					"midpoints" : [ 623.0, 271.5, 830.0, 271.5, 830.0, 220.5, 850.5, 220.5 ],
					"order" : 0,
					"source" : [ "obj-66", 0 ]
				}
