...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 144.5, 314.0, 35.0 ],
					"text" : "Create a new patcher using cmd/ctrl + n and make sure it is unlocked."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 137.5, 37.0, 42.0 ],
					"text" : "2",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.0, 374.5, 335.0, 39.0 ],
					"text" : "Synths product a mono signal. You can add audio effects to mono and stereo signals"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.0, 192.5, 375.0, 54.0 ],
					"text" : "This is a midi note message followed by an ID that is used by Max Bricks MIDI effects. If you would like to add midi effect they go inbetween a generator and a synth."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.5, 358.5, 309.0, 35.0 ],
					"text" : "Check out other lessons to learn about synthesis and Max using Max Bricks"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 355.0, 37.0, 42.0 ],
					"text" : "5",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 273.0, 309.0, 64.0 ],
					"text" : "To get audio output, you will need to make an \"mb.audioOut~\" brick and turn on your DSP. If you need to refrence an example patch, use the one to the right or any of the help files."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 284.0, 37.0, 42.0 ],
					"text" : "4",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 202.0, 37.0, 42.0 ],
					"text" : "3",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 83.0, 37.0, 42.0 ],
					"text" : "1",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Getting Started with Max Bricks"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 196.5, 306.0, 50.0 ],
					"text" : "To add bricks to a patch, click and drag items from the browser into an unlocked patcher. You may double click any of the items to open a help patch."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 72.0, 195.0, 64.0 ],
					"text" : "The first thing you will want to do is open the Max Bricks Browser. Either go to Extras -> Max Bricks -> Browser, or click this button"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 466.0, 21.0, 245.0, 30.0 ],
					"text" : "Example Max Bricks Patch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 714.0, 497.5, 191.0, 39.0 ],
					"text" : "Audio Out outputs audio to two audio channels."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 714.0, 420.0, 191.0, 39.0 ],
					"text" : "Pan takes a mono input and spatializes it in a stereo field"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 818.0, 278.5, 150.0, 68.0 ],
					"text" : "Sine Synth is a polyphonic synthesizer that produces sine waves"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 818.0, 95.0, 152.0, 68.0 ],
					"text" : "MIDI Note Input allows you to get MIDI notes from an external MIDI controller"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 87.0, 292.5, 84.0, 23.0 ],
									"text" : "loadunique $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 85.0, 248.0, 57.0, 23.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 54.0, 177.0, 152.0, 23.0 ],
									"text" : "sprintf %s/Browser.maxpat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 54.0, 134.0, 77.0, 23.0 ],
									"text" : "absolutepath"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 87.0, 367.0, 53.0, 23.0 ],
									"text" : "pcontrol"
								}
...
,
					"patching_rect" : [ 280.0, 99.0, 89.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 280.0, 71.0, 24.0, 24.0 ]
				}
...
,
					"patching_rect" : [ 509.0, 69.0, 290.0, 120.0 ],
					"varname" : "mb.notein[1]",
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"restore" : [ 4.298282011964903, 1423.762236774438634, 0.323529411764705, 389.869425349196092, 0.0, 1.0, 0.0, 0.0, 1.0, 1.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
...
,
					"patching_rect" : [ 509.0, 252.5, 290.0, 120.0 ],
...
,
					"patching_rect" : [ 509.0, 420.0, 190.0, 40.0 ],
					"varname" : "mb.pan~[1]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 509.0, 472.0, 190.0, 90.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 451.0, 13.0, 608.0, 557.0 ],
					"proportion" : 0.39
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-12::obj-25" : [ "dspState[3]", "dspState", 0 ],
			"obj-12::obj-3" : [ "live.gain~[5]", "live.gain~", 0 ],
			"obj-12::obj-9" : [ "live.numbox[5]", "live.numbox", 0 ],
			"obj-3::obj-3" : [ "midiInputSelect", "midiInputSelect", 0 ],
			"obj-6::obj-19" : [ "live.text[2]", "live.text[1]", 0 ],
			"obj-6::obj-4" : [ "wavefold[1]", "wavefold", 0 ],
			"obj-6::obj-44" : [ "live.numbox[1]", "live.numbox", 0 ],
			"obj-6::obj-76" : [ "live.gain~[6]", "live.gain~", 0 ],
			"obj-6::obj-93" : [ "live.text[1]", "live.text", 0 ],
			"obj-9::obj-2" : [ "pan[1]", "pan", 0 ],
			"obj-9::obj-27" : [ "gain[3]", "gain", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
